        ...
        if (tableRef.current) {
            ...
            tabulatorRef.current = new Tabulator(tableRef.current, {
                ...
                columns: [
                    ...
                    { title: 'First Name', field: 'firstName', sorter: 'string', headerMenu: headerMenu, headerFilter:"input"},
                    { title: 'Last Name', field: 'lastName', sorter: 'string', headerMenu: headerMenu, headerFilter:"input" },
                    { title: 'Email', field: 'email', sorter: 'string', headerMenu: headerMenu, headerFilter:"input" },
                    { title: 'Active', field: 'activebool', formatter: 'tickCross', headerMenu: headerMenu, headerFilter:"tickCross" },
                    { title: 'Store ID', field: 'storeId', sorter: 'number', headerMenu: headerMenu,headerFilter:"number" },
                ],
            });
            ...
            tabulatorRef.current.on("rowClick", (e, row) => {
                ...
                alert(`${row.getData().firstName}님의 행이 선택되었습니다.`);
            });
